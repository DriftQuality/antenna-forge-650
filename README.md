...
```bash
git clone https://github.com/DriftQuality/antenna-forge-650.git
cd antenna-forge-650
python setup.py
```
...
# Clone the project
git clone https://github.com/DriftQuality/antenna-forge-650 yaf && cd yaf
...
<!-- Last updated: 2026-06-06 20:14:25 -->
